...
add_action('wp_enqueue_scripts', 'federalconference_scripts', 100);
function federalconference_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  /*wp_register_script(
    'federalconference-scripts', 
    get_template_directory_uri() . '/js/federalconference-scripts.js',
    array('jquery'), 
    '', 
    true
  );*/ 
  ...
  //wp_enqueue_script('federalconference-scripts'); 
}

add_action('wp_enqueue_scripts', 'federalconference_styles');
function federalconference_styles(){
  ...
  wp_register_style('federalconference', get_template_directory_uri() . '/style.css');
  
  wp_enqueue_style('bootstrap-css');
  wp_enqueue_style('fontawesome');
  wp_enqueue_style('federalconference');
}
